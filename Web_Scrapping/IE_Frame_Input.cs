...
{ 
    public sealed class IE_Frame_Input : CodeActivity
    { 
            [Category("Targeting Tag")]
            [RequiredArgument]
            [DisplayName("Iframe Name")]
            public InArgument<string> tblname { get; set; }
            ...
            protected override void Execute(CodeActivityContext context)
            {
                ...
                //try
                //{
                Internet_Explore.IFrame_Tag_Element(Tag, Gettatt, Getattval, Setatt, Setattval);
