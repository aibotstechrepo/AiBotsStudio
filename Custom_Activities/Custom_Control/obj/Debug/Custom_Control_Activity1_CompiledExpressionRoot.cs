namespace Custom_Control {
    ...
    #line 14 "D:\Studio_New\AiBotsStudio\Custom_Activities\Custom_Control\Activity1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "D:\Studio_New\AiBotsStudio\Custom_Activities\Custom_Control\Activity1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 15 "D:\Studio_New\AiBotsStudio\Custom_Activities\Custom_Control\Activity1.xaml"
    ...
    #line 16 "D:\Studio_New\AiBotsStudio\Custom_Activities\Custom_Control\Activity1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 17 "D:\Studio_New\AiBotsStudio\Custom_Activities\Custom_Control\Activity1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 18 "D:\Studio_New\AiBotsStudio\Custom_Activities\Custom_Control\Activity1.xaml"
    using System.Text;
    ...
    public partial class Activity1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((this.dataContextActivities == null)) {
                this.dataContextActivities = Activity1_TypedDataContext2.GetDataContextActivitiesHelper(this.rootActivity, this.forImplementation);
            }
            if ((expressionId == 0)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext2.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 2);
                if ((cachedCompiledDataContext[0] == null)) {
                    cachedCompiledDataContext[0] = new Activity1_TypedDataContext2(locations, activityContext, true);
                }
                Activity1_TypedDataContext2 refDataContext0 = ((Activity1_TypedDataContext2)(cachedCompiledDataContext[0]));
                return refDataContext0.GetLocation<string>(refDataContext0.ValueType___Expr0Get, refDataContext0.ValueType___Expr0Set, expressionId, this.rootActivity, activityContext);
            }
            if ((expressionId == 1)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext2_ForReadOnly.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 2);
                if ((cachedCompiledDataContext[1] == null)) {
                    cachedCompiledDataContext[1] = new Activity1_TypedDataContext2_ForReadOnly(locations, activityContext, true);
                }
                Activity1_TypedDataContext2_ForReadOnly valDataContext1 = ((Activity1_TypedDataContext2_ForReadOnly)(cachedCompiledDataContext[1]));
            ...
            if ((expressionId == 2)) {
                ...
                Activity1_TypedDataContext2_ForReadOnly valDataContext2 = ((Activity1_TypedDataContext2_ForReadOnly)(cachedCompiledDataContext[1]));
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 0)) {
                Activity1_TypedDataContext2 refDataContext0 = new Activity1_TypedDataContext2(locations, true);
                return refDataContext0.GetLocation<string>(refDataContext0.ValueType___Expr0Get, refDataContext0.ValueType___Expr0Set);
            }
            if ((expressionId == 1)) {
                Activity1_TypedDataContext2_ForReadOnly valDataContext1 = new Activity1_TypedDataContext2_ForReadOnly(locations, true);
                return valDataContext1.ValueType___Expr1Get();
            }
            if ((expressionId == 2)) {
                Activity1_TypedDataContext2_ForReadOnly valDataContext2 = new Activity1_TypedDataContext2_ForReadOnly(locations, true);
                return valDataContext2.ValueType___Expr2Get();
            }
            return null;
        }
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            if (((isReference == true) 
                        && ((expressionText == "File_List") 
                        && (Activity1_TypedDataContext2.Validate(locations, true, 0) == true)))) {
                expressionId = 0;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "@\"E:\\Invoice PDF\"") 
                        && (Activity1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 1;
                return true;
            }
            if (((isReference == false) 
                        && ((expressionText == "File_List.Length") 
                        && (Activity1_TypedDataContext2_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 2;
                return true;
            }
        ...
        public System.Linq.Expressions.Expression GetExpressionTreeForExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences) {
            if ((expressionId == 0)) {
                return new Activity1_TypedDataContext2(locationReferences).@__Expr0GetTree();
            }
            if ((expressionId == 1)) {
        ...
        private class Activity1_TypedDataContext2 : Activity1_TypedDataContext1 {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 57 "D:\STUDIO_NEW\AIBOTSSTUDIO\CUSTOM_ACTIVITIES\CUSTOM_CONTROL\ACTIVITY1.XAML"
          ...
          File_List = value;
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 0)].Name != "File_List") 
                            || (locationReferences[(offset + 0)].Type != typeof(string)))) {
                    return false;
                }
                if (((locationReferences[(offset + 1)].Name != "variable1") 
        ...
        private class Activity1_TypedDataContext2_ForReadOnly : Activity1_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 52 "D:\STUDIO_NEW\AIBOTSSTUDIO\CUSTOM_ACTIVITIES\CUSTOM_CONTROL\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
          @"E:\Invoice PDF";
          ...
          @"E:\Invoice PDF";
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 64 "D:\STUDIO_NEW\AIBOTSSTUDIO\CUSTOM_ACTIVITIES\CUSTOM_CONTROL\ACTIVITY1.XAML"
