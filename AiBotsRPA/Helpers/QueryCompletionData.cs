...
namespace AibotsRPA.Helpers
{
    public class QueryCompletionData : ICompletionData
    {
        ...
        {
            return BitmapFrame.Create(typeof(QueryCompletionData).Assembly.GetManifestResourceStream("AibotsRPA.Resources.ExpressionEditor." + resourceName));
        }
